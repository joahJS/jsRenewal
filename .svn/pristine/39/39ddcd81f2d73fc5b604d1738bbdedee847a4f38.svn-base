...
var WebCubeAgentVersion = '1.2.1.9';
// 웹큐브 ActiveX 버전
var WebCubeVersion = '4,2,2,2';
// 웹큐브 설치후 접속할 페이지를 설정합니다.
// var WebCube_NextPage = "/usrSrc/js/WebCube/Customer.htm";
var WebCube_NextPage = "default_main.do";
...
function InputPolicyInfo(){
	...
	arrSetProtect[9] = "0";		// ClipBoard(Ctrl+C)기능 차단(0) / 허용 (1)
	arrSetProtect[10] = "0";		// ClipBoard(Ctrl+V) 기능 차단(0) / 허용 (1)	
...
// 설치파일 경로('/'까지 적어야 함)
var WebCube_SetupFilePath = "/usrSrc/js/WebCube/components/";
// 이미지 파일 경로('/'까지 적어야 함)
var WebCube_ImageFilePath = "/usrSrc/js/WebCube/img/";
...
var WebCube_MacOS = "/usrSrc/js/WebCube/MAC.htm";		//MAC용 WEBCUBE 호출 페이지로 리다이렉션
