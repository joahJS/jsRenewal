...
function StartAxtiveX()
{
	...
	if((clintInfoObj.appVersion.toLowerCase().indexOf("x64") < 0) &&(clintInfoObj.appVersion.toLowerCase().indexOf("wow64") < 0))
	{
		...
		'width="0" height="0" id="Obj" codebase="usrSrc/js/WebCube/components/WebCube.cab#version='+WebCubeVersion+'" ' +
	...
	else
	{
		if(browser.toLowerCase() != "win64") 
		{
			...
			'width="0" height="0" id="Obj" codebase="usrSrc/js/WebCube/components/WebCubewow.cab#version='+WebCubeVersion+'" ' +
			'VIEWASTEXT onerror="NoneActiveX()" onreadystatechange="SetActiveXState()"></object>';			
		}
		else
		{
			...
			'width="0" height="0" id="Obj" codebase="usrSrc/js/WebCube/components/WebCube64.cab#version='+WebCubeVersion+'" ' +
			'VIEWASTEXT onerror="NoneActiveX()" onreadystatechange="SetActiveXState()"></object>';
		}
	}
	document.write(str);
