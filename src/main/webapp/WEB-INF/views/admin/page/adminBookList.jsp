...
<head>
    ...
    <script src="/admSrc/js/adminBookList.js?v=<%=System.currentTimeMillis()%>" defer></script>
...
<body>
    <div id="wrap">
        ...
        <section id="contentView" data-sub-route="community" data-sub-route-current="소장 자료"></section>
    </div>
    ...
    <section id="adminContent">
        <article class="web-common-inner">
            <div class="admin-list-topline">
                ...
                <button onclick="location.href='/admin/adminBook.do'">
